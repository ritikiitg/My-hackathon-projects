...
<p align="center"><i>Three-layer adaptive bot defense.</i></p>
...
> **Hackathon submission · Problem Statement 2 — Fraud & Bot Detection.**
...
The judge confirmed in the briefing that current fake/bot-vs-real-user blockage ratio is _"somewhere low, a little higher than that"_ — meaning they suffer **both** uncaught scrapers **and** false-positive complaints. A single hard rate-limit can't fix both. **this1** tiers the response:
...
| --------------------- | -------------------------------------------------------------------------- | ------------------------------------- |
| http://localhost:3000 | Mini clone — search, browse companies, click salaries                      | The "prey" — what bots want to scrape |
...
│
├── frontend/
│   ├── site/                        ← mini clone (React + Vite + Tailwind)
│   │   ├── src/
...
<p align="center">
  <i>Built for the hackathon · May 2026</i>
</p>
